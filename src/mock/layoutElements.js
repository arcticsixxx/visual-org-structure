...
import { treeRootId } from "./initialElements";
...
export const layoutElements = (tree, rootId, direction = "TB") => {
  ...
  if (!(rootId === treeRootId)) {
    const rootButtonNode = {};
    rootButtonNode.data = { label: "...", isButton: true };
    rootButtonNode.id = "-";
    rootButtonNode.type = "customRoot";
    rootButtonNode.width = 75;
    rootButtonNode.height = nodeHeight;
    rootButtonNode.position = {
      x: -100,
      y: 0,
    };
    nodes.push(rootButtonNode);
  }
